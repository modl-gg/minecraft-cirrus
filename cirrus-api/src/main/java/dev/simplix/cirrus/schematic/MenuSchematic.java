...
public interface MenuSchematic {
    ...
    /**
     * Get the typical size of the menu using the latest protocol version
     *
    ...
    /**
     * Set the type of the menu. See {@link CirrusInventoryType}
     *
     * @param type type to set
     * @return this
     */
    MenuSchematic type(CirrusInventoryType type);
    ...
    /**
     * Set an item to the menu See {@link CirrusBaseItemStack}
     *
     * @param item          Item to set
     ...
     * @return this
     */
    MenuSchematic set(CirrusBaseItemStack item, int slot, @Nullable String actionHandler);

    /**
     * Get the element of the menu at the given slot. Will return null if there is no item at the given
     ...
     */
    @Nullable
    CirrusBaseItemStack get(int slot);
     ...
     * @return this
     */
    int add(CirrusBaseItemStack item, @Nullable String actionHandler);
