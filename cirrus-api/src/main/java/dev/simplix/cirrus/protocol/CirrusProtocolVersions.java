package dev.simplix.cirrus.protocol;

public final class CirrusProtocolVersions {

    private CirrusProtocolVersions() {
    }
    ...
    public static final int MINECRAFT_LATEST = MINECRAFT_1_21_11;
}
